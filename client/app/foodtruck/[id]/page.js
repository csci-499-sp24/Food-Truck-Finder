...
export default async function Page(slug) {
 ...
 UI-stuff
            ...
            {/* <Button variant="outlined" >
              <Link href={'/'} style={{textDecoration: 'none', color: 'white'}} >Contact Us</Link>
            </Button> */}
           <Button variant="outlined" style={{ backgroundColor: 'white' }}>
              <Link href={'/'} style={{ textDecoration: 'none', color: 'black' }}>
                Contact Us
...
// import ContactForm from "../../../compenents/ContactForm"; // Import your ContactForm component
// import { headers } from "next/headers";
// require("dotenv").config();

// // Your existing fetchData, fetchImage, fetchImageList, generateMetadata, and Page function definitions...
...
//           {/* Contact Us Button - Navigate to ContactForm */}
//           <Button variant="outlined">
//             <Link href="/contact">
